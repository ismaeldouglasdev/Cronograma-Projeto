...
const i18n = {
  'pt-BR': {
    ...
    landing: {
      ...
      nav_faq: 'FAQ',
      hero_badge: '100% gr\u00e1tis \u2022 Open Source',
      hero_cta2: 'Ver recursos',
      features_title: 'Tudo para sua rotina de estudos',
      how_title: 'Como funciona',
      how_subtitle: 'Tr\u00eas passos simples para transformar seus estudos',
      step1_title: 'Organize',
      step1_desc: 'Crie suas mat\u00e9rias, monte o quadro de hor\u00e1rios e cadastre suas tarefas com prazos.',
      step2_title: 'Estude com foco',
      step2_desc: 'Use o timer Pomodoro, registre sess\u00f5es e acompanhe o tempo dedicado a cada mat\u00e9ria.',
      step3_title: 'Evolua',
      step3_desc: 'Ganhe XP, moedas e conquistas a cada sess\u00e3o \u2014 e mantenha seu streak no ritmo.',
      cta_title: 'Pronto para estudar com disciplina?',
      cta_desc: 'Crie sua conta gratuita e transforme sua rotina de estudos hoje mesmo.',
      cta_btn: 'Acessar Cronograma',
      faq_title: 'Perguntas frequentes',
      faq1_q: 'O Cronograma \u00e9 gratuito?',
      faq1_a: 'Sim! O projeto \u00e9 100% gratuito e open source, sem an\u00fancios e sem planos pagos.',
      faq2_q: 'Preciso criar uma conta para usar?',
      faq2_a: 'Sim \u2014 a conta \u00e9 gratuita e permite sincronizar seus dados, progresso e conquistas.',
      faq3_q: 'Como funciona o sistema de gamifica\u00e7\u00e3o?',
      faq3_a: 'Voc\u00ea ganha XP por minutos estudados e tarefas conclu\u00eddas, sobe de n\u00edvel, acumula moedas e desbloqueia conquistas.',
      faq4_q: 'O que \u00e9 o streak?',
      faq4_a: '\u00c9 a sequ\u00eancia de dias com atividade de estudo. Use freezes para proteg\u00ea-la em dias corridos.',
    },
...
btn_iniciar: 'Iniciar',
  ...
  btn_pular: 'Pular',
    ...
    gamificacao: {
      ...
      // Achievements (chave: categoria_requisito)
      ach: {
        xp_100: { title: 'Primeiros Passos', desc: 'Ganhe 100 XP' },
        xp_500: { title: 'Dedicado', desc: 'Ganhe 500 XP' },
        xp_1000: { title: 'Estudioso', desc: 'Ganhe 1000 XP' },
        xp_5000: { title: 'Mestre', desc: 'Ganhe 5000 XP' },
        xp_10000: { title: 'Lenda', desc: 'Ganhe 10000 XP' },
        streak_3: { title: 'Início', desc: '3 dias consecutivos' },
        streak_7: { title: 'Consistente', desc: '7 dias consecutivos' },
        streak_14: { title: 'Focado', desc: '14 dias consecutivos' },
        streak_30: { title: 'Dedicado', desc: '30 dias consecutivos' },
        streak_100: { title: 'Lenda', desc: '100 dias consecutivos' },
        pomodoro_1: { title: 'Primeiro', desc: 'Complete 1 pomodoro' },
        pomodoro_10: { title: 'Aquecido', desc: 'Complete 10 pomodoros' },
        pomodoro_50: { title: 'Fogo', desc: 'Complete 50 pomodoros' },
        pomodoro_100: { title: 'Mestre', desc: 'Complete 100 pomodoros' },
        pomodoro_500: { title: 'Lendário', desc: 'Complete 500 pomodoros' },
        tasks_1: { title: 'Início', desc: 'Complete 1 tarefa' },
        tasks_10: { title: 'Motivado', desc: 'Complete 10 tarefas' },
        tasks_50: { title: 'Produtivo', desc: 'Complete 50 tarefas' },
        tasks_100: { title: 'Expert', desc: 'Complete 100 tarefas' },
        tasks_500: { title: 'Lenda', desc: 'Complete 500 tarefas' },
        level_2: { title: 'Level 2', desc: 'Atinga level 2' },
        level_5: { title: 'Level 5', desc: 'Atinga level 5' },
        level_10: { title: 'Level 10', desc: 'Atinga level 10' },
        level_25: { title: 'Level 25', desc: 'Atinga level 25' },
        level_50: { title: 'Level 50', desc: 'Atinga level 50' },
        coins_10: { title: 'Primeiras Moedas', desc: 'Acumule 10 coins' },
        coins_50: { title: 'Economizador', desc: 'Acumule 50 coins' },
        coins_100: { title: 'Poupador', desc: 'Acumule 100 coins' },
        coins_500: { title: 'Investidor', desc: 'Acumule 500 coins' },
        coins_1000: { title: 'Milionário', desc: 'Acumule 1000 coins' }
      },
    },
  ...
  'en': {
    landing: {
      ...
      features_title: 'Everything for your study routine',
      how_title: 'How it works',
      how_subtitle: 'Three simple steps to transform your studies',
      step1_title: 'Organize',
      step1_desc: 'Create your subjects, set up the schedule board, and add tasks with deadlines.',
      step2_title: 'Study with focus',
      step2_desc: 'Use the Pomodoro timer, log sessions, and track the time spent on each subject.',
      step3_title: 'Level up',
      step3_desc: 'Earn XP, coins, and achievements every session \u2014 and keep your streak going.',
      cta_title: 'Ready to study with discipline?',
      cta_desc: 'Create your free account and transform your study routine today.',
      cta_btn: 'Access Cronograma',
      faq_title: 'Frequently asked questions',
      faq1_q: 'Is Cronograma free?',
      faq1_a: 'Yes! The project is 100% free and open source, with no ads and no paid plans.',
      faq2_q: 'Do I need to create an account to use it?',
      faq2_a: 'Yes \u2014 the account is free and lets you sync your data, progress, and achievements.',
      faq3_q: 'How does the gamification system work?',
      faq3_a: 'You earn XP for studied minutes and completed tasks, level up, collect coins, and unlock achievements.',
      faq4_q: 'What is the streak?',
      faq4_a: 'It is your sequence of days with study activity. Use freezes to protect it on busy days.',
    },
...
btn_iniciar: 'Start',
  ...
  btn_pular: 'Skip',
    ...
    gamificacao: {
      ...
      // Achievements (key: category_requirement)
      ach: {
        xp_100: { title: 'First Steps', desc: 'Earn 100 XP' },
        xp_500: { title: 'Dedicated', desc: 'Earn 500 XP' },
        xp_1000: { title: 'Studious', desc: 'Earn 1000 XP' },
        xp_5000: { title: 'Master', desc: 'Earn 5000 XP' },
        xp_10000: { title: 'Legend', desc: 'Earn 10000 XP' },
        streak_3: { title: 'Kickoff', desc: '3 consecutive days' },
        streak_7: { title: 'Consistent', desc: '7 consecutive days' },
        streak_14: { title: 'Focused', desc: '14 consecutive days' },
        streak_30: { title: 'Devoted', desc: '30 consecutive days' },
        streak_100: { title: 'Legend', desc: '100 consecutive days' },
        pomodoro_1: { title: 'First', desc: 'Complete 1 pomodoro' },
        pomodoro_10: { title: 'Warmed Up', desc: 'Complete 10 pomodoros' },
        pomodoro_50: { title: 'On Fire', desc: 'Complete 50 pomodoros' },
        pomodoro_100: { title: 'Master', desc: 'Complete 100 pomodoros' },
        pomodoro_500: { title: 'Legendary', desc: 'Complete 500 pomodoros' },
        tasks_1: { title: 'Kickoff', desc: 'Complete 1 task' },
        tasks_10: { title: 'Motivated', desc: 'Complete 10 tasks' },
        tasks_50: { title: 'Productive', desc: 'Complete 50 tasks' },
        tasks_100: { title: 'Expert', desc: 'Complete 100 tasks' },
        tasks_500: { title: 'Legend', desc: 'Complete 500 tasks' },
        level_2: { title: 'Level 2', desc: 'Reach level 2' },
        level_5: { title: 'Level 5', desc: 'Reach level 5' },
        level_10: { title: 'Level 10', desc: 'Reach level 10' },
        level_25: { title: 'Level 25', desc: 'Reach level 25' },
        level_50: { title: 'Level 50', desc: 'Reach level 50' },
        coins_10: { title: 'First Coins', desc: 'Collect 10 coins' },
        coins_50: { title: 'Saver', desc: 'Collect 50 coins' },
        coins_100: { title: 'Stasher', desc: 'Collect 100 coins' },
        coins_500: { title: 'Investor', desc: 'Collect 500 coins' },
        coins_1000: { title: 'Millionaire', desc: 'Collect 1000 coins' }
      },
    },
